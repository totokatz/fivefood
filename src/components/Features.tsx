  ...
  return (
    <section id="nutrition" className="py-16 md:py-24 bg-surface px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 reveal-stagger">
          {features.map((f) => (
            <div
              key={f.label}
              className="reveal bg-primary-container/20 p-4 md:p-8 rounded-xl flex flex-col items-center text-center group hover:bg-primary-container/40 transition-colors tap-active"
            >
